...
const AddIncomePage = ({ bottomSheetRef }) => {
    ...
    return (
        <BottomSheetView style={styles.container}>
            ...
            <EditCategoryButton categories = {availableCategories} redirectType={'income'} onPress={() => {
                setTriggerDataReload(true)
            }} />
            ...
            <SubmitButton amount={amount} category={category} redirectType={'income'} bottomSheetRef={bottomSheetRef} clearSelections={clearSelections} />
        </BottomSheetView>
    )
}
